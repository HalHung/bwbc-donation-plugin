<template>
  <div id="component-body">
    <el-form :model="transferInfo" :rules="rules" ref="transferInfo">
      ...
      <p style="color: #9c8044; font-weight: 500; font-size: 24px">匯款資訊</p>
      <el-row>
        <el-col>
          <span class="sub-title">匯款帳號末五碼</span>
      ...
      <el-row>
        <el-col>
          <span class="sub-title">匯款日期：</span>
        </el-col>
        <el-col :span="8">
          <el-form-item>
            <el-date-picker
              v-model="transferInfo.date1"
              type="date"
              placeholder="請選擇匯款日期"
            ></el-date-picker>
          </el-form-item>
      ...
      <el-row>
        <el-col>
          <span class="sub-title">匯款單照片</span>
          <span class="required-mark">*</span>
          <span class="sub-title">:</span>
        </el-col>
        <el-col :span="8">
...
export default {
  ...
  methods: {
    ...
    selectFile(e) {
      ...
      reader.onload = (e) => {
        this.transferInfo.imgData.content = e.target.result.substr(
